...
CREATE TABLE Restaurant(
    id int primary key generated by default as identity ,
    admin_id int references SystemUser(id) not null unique ,
...
CREATE TABLE Purchase(
    ...
    system_user_id int references SystemUser(id)
);

ALTER TABLE SystemUser ADD COLUMN restaurant_id int references Restaurant(id) unique;
